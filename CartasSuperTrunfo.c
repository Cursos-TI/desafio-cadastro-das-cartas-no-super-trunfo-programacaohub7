...
int main() {
    ...
    int habitates1  = 1; //  número de habitantes da cidade.
 
    float area1  = 1; // área da cidade em quilômetros quadrados.
 
    float pib1  = 1; // produto Interno Bruto da cidade.
 
    int pontos_turisticos1 = 1; //
    ...
    int habitates2 = 1; //  número de habitantes da cidade.
 
    float area2 = 1; // área da cidade em quilômetros quadrados.
 
    float pib2 = 1; // produto Interno Bruto da cidade.
 
    int pontos_turisticos2 = 1; //
